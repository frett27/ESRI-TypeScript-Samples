...
/// <reference path="../../../../../Dojo-TypeScript/fake.d.ts" />

/// <reference path="TOC.d.ts" />
...
import _Templated = require("dijit/_TemplatedMixin");
import Evented = require("dojo/Evented");
import gfx = require("dojox/gfx");
import coreFx = require("dojox/fx");
import Toggler = require("dojo/fx/Toggler");
...
var _TOCNode = (function(){ 
    ...
    function constructeur(params, srcNodeRef){
    ...
    function _createRootLayerNode(rootLayer){
    ...
    function _createServiceLayerNode(serviceLayer){
     ...
     */
    function _createLegendNode(rendLeg){
      this._noCheckNode = true;
      domConstruct.destroy(this.containerNode);
    ...
    function _setIconNode(rendLeg, iconNode, tocNode){
    ...
    function _createSymbol(mySurface, descriptors, w, h){
    ...
    function _getLegendIconUrl(legend){
      var src = legend.url;
     ...
     */
    function _createChildrenNodes(chdn, type){
      this.rootLayerTOC._currentIndent++;
      var c = [];
      ...
      domClass.contains(this.iconNode, 'dijitTreeExpandoOpened')) {
        ...
        if (domClass.contains(this.iconNode, 'dijitTreeExpandoOpened')) {
          if (this.toggler) {
            ...
            domUtils.show(this.containerNode);
          }
        } else {
          if (this.toggler) {
            this.toggler.hide();
          } else {
            domUtils.hide(this.containerNode);
          }
        }
	...
	var _TOCNodeProps = {
		...
		_createRootLayerNode:_createRootLayerNode,
		_createServiceLayerNode:_createServiceLayerNode,
		_createLegendNode:_createLegendNode,
		_setIconNode:_setIconNode,
		_createSymbol:_createSymbol,
		_getLegendIconUrl:_getLegendIconUrl,
		_createChildrenNodes:_createChildrenNodes,
		_toggleContainer:_toggleContainer,
		expand:expand,
		collapse:collapse,
		show:show,
		hide:hide,
		_adjustToState:_adjustToState,
		_onClick:_onClick,
		_setSubLayerVisibilitiesFromGroup:_setSubLayerVisibilitiesFromGroup,
		_getVisibleLayers:_getVisibleLayers,
		_findTOCNode:_findTOCNode
	}
   ...
   * @private
   */
	return dojo_declare([_Widget, _Templated],_TOCNodeProps); 
...
var _RootLayerTOC = (function() {
	 ...
	 var _RootLayerTOCProps = {
		...
		tocWidget: null,
		postCreate:postCreate,
		_getLegendInfo:_getLegendInfo,
		 _processLegendError:_processLegendError,
		_processLegendInfo:_processLegendInfo,
		destroy:destroy,
		_createRootLayerTOC:_createRootLayerTOC,
		onLoad:onLoad,
		_refreshLayer:_refreshLayer,
		_onSetVisibleLayers:_onSetVisibleLayers,
		_adjustToState:_adjustToState

	}

    return dojo_declare([_Widget],_RootLayerTOCProps);
     ...
     */
    function constructeurRootLayerTOC(params, srcNodeRef){
    ...
    function _processLegendError(err){
      this._createRootLayerTOC();
    }
    function _processLegendInfo(json){
    ...
    function _refreshLayer(){
	 ...
	 function _onSetVisibleLayers(visLayers, doNotRefresh){
      // 2012-07-23:
...
var TOC = (function() {
    ...
    function _createTOC(){
      ...
      for (var i = 0, c = this.layerInfos.length; i < c; i++) {
        ...
        this._checkLoadHandler = rootLayerTOC.on('load', lang.hitch<(e:Event)=>boolean>(this, '_checkLoad'));//dojo .connect(rootLayerTOC, 'onLoad', this, '_checkLoad');
...
var props_TOC = {
    ...
    layerInfos: null,
    constructor : constructeur,
	findTOCNode : findTOCNode,
	destroy : destroy,
	refresh : refresh,
	_adjustToState:_adjustToState,
	_checkLoad:_checkLoad,
	_createTOC:_createTOC,
	postCreate:postCreate,
	onLoad:onLoad
};

var TOC=dojo_declare([_Widget, Evented], props_TOC);
return TOC;
